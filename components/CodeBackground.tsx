...
const SNIPPET: string[] = [
  ...
  "    private readonly IDeliveryPricer _pricer;",
  "",
  "    public DeliveryController(",
  "        ApplicationDbContext db,",
  "        IDeliveryPricer pricer)",
  "    {",
  "        _db = db;",
  "        _pricer = pricer;",
  "    }",
  ...
  "",
  "        var kitchenOpen = await _db.Hours",
  "            .AnyAsync(h => h.Covers(DateTime.UtcNow));",
  "",
  "        if (!kitchenOpen)",
  "        {",
  ...
  "            Items = dto.Items.Select(i => new OrderLine",
  "            {",
  ...
  "        };",
  "",
  "        order.Total = _pricer.Quote(order);",
  "",
  "        _db.Orders.Add(order);",
  "        await _db.SaveChangesAsync();",
  "",
  "        _logger.LogInformation(",
  "            \"Order {Id} placed for {Total:C}\",",
  "            order.Id, order.Total);",
  "",
  "        return RedirectToAction(",
  "            nameof(Confirmation), new { id = order.Id });",
  "    }",
  "",
  "    [HttpGet]",
